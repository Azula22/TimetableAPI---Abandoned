...
object SubjectService {
  ...
  def addSubject(subject: Subject): Future[String] = {
    Points.add(subject)
  }

  def deleteSubjectByID(id: Long): Future[Int] = {
    Points.delete(id)
  }

  def getSubjectByID(id: Long): Future[Option[Subject]] = {
    Points.get(id)
  }
  ...
  def getGroupByName(name: String): Future[Seq[Subject]] = {
    Points.getGroup(name)
  }

  def teacherByID(teacherID: Long): Future[Seq[Subject]] = {
    Points.getTeacherByID(teacherID)
  }
